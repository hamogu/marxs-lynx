...
def facet_table(gas):
    ...
    Parameters
    ----------
    gas : `marxs.simulator.Parallel` instance
    ...
    facetgrooveang = [e.elements[0].geometry['groove_angle'] for e in gas.elements]
    facetcoating = [e.elements[0].order_selector.coating if hasattr(e.elements[0].order_selector, 'coating') else '--' for e in gas.elements]
